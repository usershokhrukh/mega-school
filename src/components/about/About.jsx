...
//    useGSAP(() => {
//     // Animates the text block when it enters the viewport
//     gsap.from('.about-text-block', {
//       x: 150,           // Starts 150px to the right of its original position
//       opacity: 0,       // Starts completely invisible
//       duration: 1.2,    // Animation takes 1.2 seconds to complete
//       ease: 'power3.out', // Smooth deceleration effect
//       scrollTrigger: {
//         trigger: '.about-text-block',
//         start: 'top 85%', // Triggers when the top of the text hits 85% of viewport height
